...
const ImageSelector = ({ setSelectedAssetId, setOpenSelect }: { setSelectedAssetId: Function, setOpenSelect: Function }) => {
    ...
    useEffect(() => {
        if (data) {
            ...
            console.log(data, "  imges  ", formImages);
    ...
    return (
        <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center z-50">
            ...
            <div className="bg-white rounded-lg p-8 w-[80%] max-h-[80%] overflow-hidden relative">
                <button onClick={() => setOpenSelect(false)} className="absolute top-0 right-0 m-4 px-2 py-1 text-gray-700 bg-gray-300 rounded-full hover:bg-gray-400 focus:outline-none">Close</button>
