        ...
        <div className='flex flex-col w-[calc(100vw-240px)] gap-5 ' style={{ overflowY: "auto", overflowX: "hidden" }}>
            ...
            <div className="shadow-md rounded-b-lg ">
                ...
                <div className='flex flex-row justify-center items-center align-middle p-3  pt-10' style={{ overflowY: "auto", overflowX: "hidden" }}>
                    <Formik
                        initialValues={{
                            author: '', category: categoryary, description: getblogResponse.data?.getBlog?.description, featured: getblogResponse.data?.getBlog?.featured, keywords: getblogResponse.data?.getBlog?.keywords || [], metaDescription: getblogResponse.data?.getBlog?.metaDescription, metaTitle: getblogResponse.data?.getBlog?.metaTitle, pin: getblogResponse.data?.getBlog?.pin, thumbnail: '', title: getblogResponse.data?.getBlog?.title, status: getblogResponse.data?.getBlog?.status,
                        }}
